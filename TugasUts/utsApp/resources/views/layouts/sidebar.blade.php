        ...
        <ul class="mt-4">
            ...
            <li class="mb-1 group">
                ...
                <ul class="pl-7 mt-2">
                    ...
                    <li class="mb-4">
                        <a href="{{route('dosen.index')}}" class="text-gray-300 text-sm flex items-center hover:text-gray-100 before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Dosen</a>
                    </li>
                </ul>
            </li>
            <li class="mb-1 group">
